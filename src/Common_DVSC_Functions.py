...
class Common_DVSC_Functions:
    def __init__(self, groupObject, generator=None):
        ...
        """
        Extension:
        - Initializes an additional group element gPrime in the elliptic curve setting.

        Reason:
        KVAC-MEQ receives G' through the DVSC constructor, while KVAC-GGM inherits
        directly from Common_DVSC_Functions. Therefore KVAC-GGM needs gPrime to be
        created here so it can be used in the non-transferability public-key binding.
        """
